...
<body>
    ...
    <div class="center">
        <label class="form-label3" for="estado">Histórico</label><br><br>

        <label class="form-label3" for="estado">Tipo de Usuario</label><br><br>
        <select class="form-control" id="idUsuario" name="idUsuario">
            <option class="form-label3" value="0">Seleccione un Usuario</option>
            <?php
        ...
        <button class="btn" id="buscar" name="buscar">Buscar</button><br><br>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th>Índice de Masa Múscular</th>
                    <th>Enfermedades</th>
                </tr>
            </thead>
            <tbody id='historial'>
                <!--CARGANDO LA INFO DEL HISTORIAL-->
            </tbody>
        </table>
        <br>
        <br>
